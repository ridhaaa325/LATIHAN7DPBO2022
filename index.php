...
// memanggil function addData
if(isset($_POST['add']))
{
	$otask->addData();
}

// memanggil function deleteData
if(isset($_GET['id_hapus']))
{
	$otask->deleteData($id = $_GET['id_hapus']);
}

// memanggil function updateData
if(isset($_GET['id_status']))
{
	$otask->updateData($id = $_GET['id_status']);
}
